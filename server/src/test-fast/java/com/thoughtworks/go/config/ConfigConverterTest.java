...
public class ConfigConverterTest {
    ...
    public void shouldConvertConfigMaterialWhenConfigRepoIsHg() {
        ...
        HgMaterialConfig configRepoMaterial = new HgMaterialConfig(new HgUrlArgument("url"), xxx, xxx, xxx, true, new Filter(new IgnoredFiles("ignore")), false, "folder", new CaseInsensitiveString("name"));
        when(context.configMaterial()).thenReturn(configRepoMaterial);
