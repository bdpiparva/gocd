...
public class AuthPluginInfoViewModelTest {
    ...
    public void shouldGetDetailsAboutThePlugin() {
        ...
        AuthorizationPluginInfo pluginInfo = new AuthorizationPluginInfo(descriptor, null, null, null, new Image("svg", "data", "hash"), new Capabilities(SupportedAuthType.Web, true, true, false, false));
